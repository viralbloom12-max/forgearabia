...
export async function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 z-40 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_12px_34px_-8px_rgba(37,211,102,0.6)] transition-transform duration-200 hover:scale-105 end-5"
    >
